package com.exercise.essential_classes.concurrency.fork_join.mergesort;
...
public class MergeSort {
    ...
    public static void main(String[] args) {
		...
		MergeSort mergeSort = new MergeSort(availableProcessors);
        int[] generateArray = generateArray(20);
    ...
    private static final Random random = new Random(759123751834L);
}
